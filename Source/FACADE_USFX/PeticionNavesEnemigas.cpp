...
ANaveEnemigo* APeticionNavesEnemigas::CrearNaveEnemiga(FString NombreNave)
{
	...
	else if (NombreNave == "Nave2")
	{
		...
		return GetWorld()->SpawnActor<ANaveEnemigo3>(ANaveEnemigo2::StaticClass());
	}
	else if (NombreNave == "Nave4") {
		return GetWorld()->SpawnActor<ANaveEnemigo4>(ANaveEnemigo2::StaticClass());
	}
	else if (NombreNave == "Nave5") {
		return GetWorld()->SpawnActor<ANaveEnemigo5>(ANaveEnemigo2::StaticClass());
	}
	return nullptr;
}
